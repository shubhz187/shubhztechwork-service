...
const TechTile = memo(({ tech, index, isHovered, onMouseEnter, onMouseLeave }: TechTileProps) => (
  <motion.div
    key={tech.iconType}
  ...
  >
    <motion.div
      ...
      className="flex flex-col items-center justify-center gap-2 sm:gap-3 p-3 sm:p-4 w-[105px] sm:w-[140px] h-full rounded-xl border border-border/50 bg-card/50 hover:border-primary/30 hover:bg-card transition-colors cursor-default"
    >
