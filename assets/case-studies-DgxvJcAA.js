const o=[{slug:"spark-ai-tutor",client:"SPARK AI Tutor",subtitle:"A Socratic AI tutoring agent that teaches through guided questioning, not just answers.",industry:"EdTech / AI",projectType:"AI Product Design + Agent Architecture",excerpt:"ShubhzTechWork designed a Socratic AI tutoring agent under the ShubhzHorizon / SPARK initiative : moving beyond answer bots to build a system that diagnoses understanding, asks layered questions, and adapts in real time.",gradient:"from-violet-500 to-purple-500",stack:["LLM Orchestration","Prompt Engineering","Multi-Agent Design","RAG","Python"],highlights:[{value:"5-Layer",label:"Tutoring Architecture"},{value:"7",label:"Agent Modules"},{value:"3-Phase",label:"Product Roadmap"}],metaTitle:"SPARK AI Tutor : Socratic AI Agent Case Study | ShubhzTechWork",metaDescription:"How ShubhzTechWork designed a Socratic AI tutoring agent with adaptive questioning, progressive hints, and modular multi-agent architecture for deeper learning outcomes.",content:`
...
`},{slug:"earthen-lifestyles-ecosystem",client:"EarthenLifestyles",subtitle:"A values-driven digital ecosystem for community, commerce, culture, and contribution.",industry:"Lifestyle / Ecosystem",projectType:"Digital Ecosystem Design + Multi-Platform Strategy",excerpt:"EarthenLifestyles needed more than a website : it needed a connected ecosystem of community, commerce, culture, and social impact, designed to start lean and scale into multiple platforms without operational chaos.",gradient:"from-emerald-500 to-teal-500",stack:["Ecosystem Architecture","Brand Strategy","Community Design","Phase Planning","UX"],highlights:[{value:"10+",label:"Platform Verticals"},{value:"3-Phase",label:"Rollout Strategy"},{value:"5-Layer",label:"Ecosystem Architecture"}],metaTitle:"EarthenLifestyles : Digital Ecosystem Design Case Study | ShubhzTechWork",metaDescription:"How ShubhzTechWork designed a phased digital ecosystem for EarthenLifestyles : combining community, commerce, culture, and contribution under a scalable, values-driven brand architecture.",content:`
<h2 class="text-2xl font-bold font-display text-foreground mt-12 mb-4">Executive Summary</h2>
...
`},{slug:"aws-connect-devops-platform",client:"Connect–Lex–Lambda DevOps Platform",subtitle:"A dependency-aware deployment engine for Amazon Connect ecosystems across AWS accounts.",industry:"Cloud / DevOps",projectType:"Cross-Account DevOps Orchestration Platform",excerpt:"We built a configuration orchestration engine that extracts, versions, packages, and deploys Amazon Connect/Lex/Lambda configurations across AWS accounts : replacing fragile manual migration with repeatable, auditable releases.",gradient:"from-orange-500 to-red-500",stack:["AWS Connect","AWS Lambda","Amazon Lex","S3","DynamoDB","STS","Java / Spring Boot","React / Vite"],highlights:[{value:"Cross-Account",label:"Deployment Engine"},{value:"Dependency-Aware",label:"Snapshotting"},{value:"Full UI",label:"Operator Dashboard"}],metaTitle:"AWS Connect DevOps Platform : Cross-Account Deployment Case Study | ShubhzTechWork",metaDescription:"How ShubhzTechWork built a dependency-aware cross-account deployment platform for Amazon Connect, Lex, and Lambda with versioned snapshots, packaging, and an operator dashboard.",content:`
<h2 class="text-2xl font-bold font-display text-foreground mt-12 mb-4">Executive Summary</h2>
...
`},{slug:"clinical-website",client:"Clinical Website",subtitle:"A professional medical clinic website built for trust, patient access, and fast delivery.",industry:"Healthcare / Medical",projectType:"Professional Clinic Website",excerpt:"A medical practitioner needed a trustworthy digital presence for his medical practice : built for patient convenience, mobile-first access, and fast launch. Delivered end-to-end in 15 days.",gradient:"from-sky-500 to-blue-500",stack:["Web Development","Content Strategy","UX Design","SEO","Mobile-First"],highlights:[{value:"15 Days",label:"Build Time"},{value:"Live",label:"Status"},{value:"End-to-End",label:"Delivery"}],metaTitle:"Clinical Website : Medical Clinic Case Study | ShubhzTechWork",metaDescription:"How ShubhzTechWork delivered a professional medical clinic website in 15 days : from requirement gathering to live production deployment.",content:`
<h2 class="text-2xl font-bold font-display text-foreground mt-12 mb-4">Executive Summary</h2>
...
`},{slug:"vulnerability-management-platform",client:"Vulnerability Management Platform",subtitle:"A centralized remediation workflow that turns security findings into action.",industry:"Cybersecurity / SecOps",projectType:"Security Operations Platform",excerpt:"A workflow-driven platform that centralizes vulnerability findings from multiple sources, applies risk-based prioritization, enforces ownership and SLA tracking, validates remediation, and maintains audit-ready evidence trails.",gradient:"from-rose-500 to-red-600",stack:["Vulnerability Management","Risk Prioritization","SLA Tracking","Audit Trails","Compliance"],highlights:[{value:"Centralized",label:"Findings Repository"},{value:"SLA-Based",label:"Remediation"},{value:"Audit-Ready",label:"Evidence Trails"}],metaTitle:"Vulnerability Management Platform : Security Operations Case Study | ShubhzTechWork",metaDescription:"How ShubhzTechWork is building a centralized vulnerability management platform with risk-based prioritization, SLA enforcement, and audit-ready remediation workflows.",content:`
...
`}];function n(e){return o.find(t=>t.slug===e)}function a(e){return o.filter(t=>t.slug!==e)}export{a,o as c,n as g};
