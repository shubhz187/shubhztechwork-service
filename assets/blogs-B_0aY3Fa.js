import{j as e,m as n}from"./vendor-motion-B7yDa6C2.js";import{L as r}from"./vendor-react-Uygcphwy.js";import{A as l}from"./OrbitStars-DTqEjkLF.js";import{C as d}from"./clock-CoQzu6bF.js";const o=["bg-violet/15","bg-orange/25","bg-green/20","bg-pink/20","bg-purple/20","bg-yellow/30"],m=({post:t,index:i})=>e.jsx(n.article,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.7,delay:i%3*.1,ease:[.22,1,.36,1]},children:e.jsxs(r,{to:`/blogs/${t.slug}`,className:"group block",children:[e.jsxs("div",{className:`aspect-[4/3] relative overflow-hidden rounded-[28px] ${o[i%o.length]}`,children:[e.jsx("div",{className:"absolute inset-0 flex items-center justify-center p-8",children:e.jsx("span",{className:"font-serif text-5xl md:text-6xl italic text-foreground/40 text-center leading-[1.05] line-clamp-4",children:t.title})}),e.jsx("div",{className:"absolute top-5 left-5",children:e.jsx("span",{className:"pill !bg-card !text-foreground",children:t.tag})}),e.jsx("div",{className:"absolute bottom-5 right-5 opacity-0 translate-y-2 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0",children:e.jsx("span",{className:"inline-flex h-11 w-11 items-center justify-center rounded-full bg-foreground text-background",children:e.jsx(l,{size:16})})})]}),e.jsxs("div",{className:"mt-5 flex items-center justify-between text-sm text-foreground/60",children:[e.jsxs("span",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"inline-flex h-7 w-7 items-center justify-center rounded-full bg-foreground/10 text-xs font-semibold text-foreground",children:t.author.initials}),t.author.name]}),e.jsxs("span",{className:"flex items-center gap-1.5",children:[e.jsx(d,{className:"h-3.5 w-3.5"}),t.readTime]})]}),e.jsx("h3",{className:"mt-3 text-xl md:text-2xl font-display leading-[1.15] transition-colors group-hover:text-foreground/80 line-clamp-3",children:t.title})]})}),s={nirmit:{name:"Nirmit Dagli",initials:"ND",role:"Founder & CEO",bio:"Visionary leader driving the strategic vision and operations of the company."},shubham:{name:"Shubham Kadam",initials:"SK",role:"Co-Founder & CFO",bio:"Financial expert ensuring sustainable growth and strong financial foundations."},kunal:{name:"Kunal Shinde",initials:"KS",role:"CoFounder & CTO",bio:"Technical mastermind building scalable architectures and leading engineering."}},a=[{slug:"securing-your-saas-practical-guide",title:"Securing Your SaaS: A Practical Guide",excerpt:"SaaS security is not a feature you add later. It is the floor your entire product stands on. This guide walks through the real decisions : auth, secrets, APIs, infrastructure, monitoring, and incident response : that separate resilient products from ticking time bombs.",author:s.nirmit,date:"Feb 20, 2026",readTime:"14 min read",tag:"Security",gradient:"from-purple-500 to-pink-500",metaTitle:"Securing Your SaaS: A Practical Guide | ShubhzTechWork",metaDescription:"A practical SaaS security guide covering auth, secrets, logging, infrastructure hardening, monitoring, and incident readiness.",content:`
...
`},{slug:"cloud-infrastructure-security-guide",title:"Cloud Infrastructure Security: Protecting Your Foundation",excerpt:"Your cloud infrastructure is the foundation everything runs on. If it is compromised, nothing above it matters. This guide covers IAM, network isolation, encryption, monitoring, and the operational discipline that separates secure cloud environments from exposed ones.",author:s.shubham,date:"Feb 15, 2026",readTime:"13 min read",tag:"Infrastructure",gradient:"from-orange-500 to-red-500",metaTitle:"Cloud Infrastructure Security: Protecting Your Foundation | ShubhzTechWork",metaDescription:"A practical guide to securing cloud infrastructure: IAM, network isolation, encryption, logging, and the operational discipline that keeps environments safe.",content:`
...
`},{slug:"devsecops-integrating-security-into-cicd",title:"DevSecOps: Integrating Security Into Your CI/CD Pipeline",excerpt:"Security that only happens in audits is security that happens too late. DevSecOps means building security checks into your CI/CD pipeline : automated, fast, and blocking only what matters. Here is how to shift left without grinding your team to a halt.",author:s.nirmit,date:"Feb 10, 2026",readTime:"12 min read",tag:"DevSecOps",gradient:"from-violet-500 to-purple-500",metaTitle:"DevSecOps: Integrating Security Into Your CI/CD Pipeline | ShubhzTechWork",metaDescription:"A practical guide to DevSecOps: integrating security scanning, secrets detection, container scanning, and compliance checks into CI/CD without slowing delivery.",content:`
...
`},{slug:"data-privacy-compliance-practical-guide",title:"Data Privacy and Compliance: A Practical Engineering Guide",excerpt:"Privacy regulations are not going away : they are expanding. GDPR, CCPA, and a growing list of frameworks mean engineering teams need to understand data classification, consent management, retention policies, and privacy by design. This is the practical version.",author:s.kunal,date:"Feb 5, 2026",readTime:"12 min read",tag:"Privacy",gradient:"from-blue-500 to-cyan-500",metaTitle:"Data Privacy and Compliance: A Practical Engineering Guide | ShubhzTechWork",metaDescription:"A practical guide to data privacy engineering: data classification, consent management, retention policies, privacy by design, and building compliance into your systems.",content:`
...
`}];function h(t){return a.find(i=>i.slug===t)}function y(t){return a.filter(i=>i.slug!==t)}export{m as B,y as a,a as b,h as g};
